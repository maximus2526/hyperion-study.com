...
<div class="header-top scheme-light">
    <div class="container">
        <div class="row">
            <div class="col">
                <ul class="nav">
                    <li>Call Now: <a class="scheme-light" href="tel:+035527171070">(+035) 527-1710-70</a></li>
                    <li>Email: <a class="scheme-light" href="mailto:Contact@hyperion.com">Contact@hyperion.com</a></li>
                </ul>
            </div>
            <div class="col">
                <ul class="nav">
                    <li>Ample end might folly quiet one set spoke.</li>
                    <li><a href="/?currency=uan" class="scheme-light">USD</a></li>
                    <li><a href="/?language=ua" class="scheme-light"><img src="views/img/svg/usa.svg" alt=""></a></li>
                </ul>
            </div> 
        </div>
    </div>
...
<div class="container header-middle">
    ...
    <div class="row header-menu">
        ...
        <div class="col-4">
            ...
            <span style="border: 1px solid gray; height: 30%; margin: 0 10px;"></span>
