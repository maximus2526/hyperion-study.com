            ...
            <div class="sidebar-section scheme-light fixed bg-dark">
                <div class="block-title display-flex space-between align-center design-bordered">
                    ...
                    <div class="sidebar-img">
                        <a href=""><img src="img/svg/browse.svg" alt=""></a>
                    </div>
                            ...
                            <ul>
                                <li class="sidebar-element">
                                    <a class="display-flex align-center gap" href="/">
                                        <img src="img/svg/sidebar-icons/dashboard.svg" alt="">
                                        <p>Dashboard</p>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="sidebar-block">
                        ...
                        <div class="sidebar-elements">
                            <ul>
                                ...
                                <li class="sidebar-element">
                                    <a class="display-flex align-center gap" href="/">
                                        <img src="img/svg/sidebar-icons/orders.svg" alt="">
                                        <p class="text">Orders</p>
                                    </a>
                                </li>
                                <li class="sidebar-element">
                                    <a class="display-flex align-center gap" href="/">
                                        <img src="img/svg/sidebar-icons/analytic.svg" alt="">
            ...
            <div class="content">
                <div class="page-header">
                    <div class="block-title">
                        <h5 class="title">Home - Dashboard</h5>
                    </div>
                </div>
                <div class="content-section">

                    <div class="content-block">
                        <div class="row content-block bg-white row-spacing">
                            <div class="col-6">
